...
public class PRINCIPAL {
    ...
    public String transforma(String registro, int qtde_reg) {
	    ...
	    Integer SITUAÇÃOCADASTRAL            = (validainteiro.validaInteger(registro.substring(223,225)));
	    Integer DATA_SITUACAOCADASTRAL       = (validainteiro.validaInteger(registro.substring(225,233)));
	    Integer MOTIVO_SITUAÇÃOCADASTRAL     = (validainteiro.validaInteger(registro.substring(233,235)));
	    ...
	    String  DESCRIÇÃO_TIPOLOGRADOURO     = (apas + registro.substring(382,402).trim().replaceAll("\"", "") + apas  );
	    ...
	    Integer QUALIFICAÇÃO_DO_RESPONSÁVEL  = (validainteiro.validaInteger(registro.substring(889,891)));
	    ...
	    String  OPÇÃO_PELO_SIMPLES           = (apas + registro.substring(907,908).trim().replaceAll("\"", "") + apas  );
	    ...
	    String  OPÇÃO_PELO_MEI               = (apas + registro.substring(924,925).trim().replaceAll("\"", "") + apas  );
	    String  SITUAÇÃO_ESPECIAL            = (apas + registro.substring(925,948).trim().replaceAll("\"", "") + apas  );
	    String  DATA_SITUAÇÃO_ESPECIAL       = (apas + registro.substring(948,956).trim().replaceAll("\"", "") + apas  );
	    ...
	    query = "Insert into TAB_PRINCIPAL values (" + 
				...
				SITUAÇÃOCADASTRAL            + virgula + 
				DATA_SITUACAOCADASTRAL       + virgula + 
				MOTIVO_SITUAÇÃOCADASTRAL     + virgula + 
				...
				CNAE_FISCAL                  + virgula + 
				DESCRIÇÃO_TIPOLOGRADOURO     + virgula + 
				LOGRADOURO                   + virgula + 
				NUMERO                       + virgula + 
				COMPLEMENTO                  + virgula + 
				BAIRRO                       + virgula + 
				...
				QUALIFICAÇÃO_DO_RESPONSÁVEL  + virgula + 
				CAPITAL_SOCIAL_DA_EMPRESA    + virgula + 
				PORTE_EMPRESA                + virgula + 
				OPÇÃO_PELO_SIMPLES           + virgula + 
				DATA_OPCAO_PELO_SIMPLES      + virgula + 
				DATA_EXCLUSÃO_DO_SIMPLES     + virgula + 
				OPÇÃO_PELO_MEI               + virgula + 
				SITUAÇÃO_ESPECIAL            + virgula + 
				DATA_SITUAÇÃO_ESPECIAL       + virgula + 
				FILLER                       + virgula + 
				FIM_DE_REGISTRO              + 
				")";
